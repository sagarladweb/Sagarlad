...
export function KPICard({
  ...
  return (
    <div className="relative rounded-2xl border border-border/50 bg-card p-5 flex flex-col transition-all duration-300 ease-out hover:border-accent/25 hover:bg-accent/[0.015]">
      <div className="flex items-center justify-between">
        <span className="text-[11px] font-medium uppercase tracking-widest text-muted-foreground/70">
          {label}
        </span>
        <span className="grid h-8 w-8 place-items-center rounded-lg bg-accent/8 text-accent/60 transition-all duration-300 hover:bg-accent/15 hover:text-accent hover:scale-105">
