...
export function ScrollAnimations() {
  ...
  useEffect(() => {
     ...
     * React hydration completes before the first paint, so by the second
     * rAF GSAP is guaranteed to run on a fully-hydrated DOM.
     */
            ...
            .forEach((layer) => {
              ...
              gsap.fromTo(
                ...
                { y: `${-60 * speed}%` },
                {
                  ...
                  scrollTrigger: {
                    trigger:
                      layer.closest("[data-parallax-wrap]") ?? layer,
                    start: "top bottom",
                    end: "bottom top",
                    scrub: 0.5,
                  },
