      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-24">
            <Pill className="mb-3">On Stage</Pill>
            ...
            <Link
              href="/speaking"
              className="btn-premium inline-flex items-center gap-2 rounded-full bg-accent text-accent-foreground px-6 py-3 text-sm font-semibold hover:opacity-95 shadow-md"
            >
          ...
          <div className="lg:col-span-8 space-y-4">
            {talks.map((t) => {
              ...
              return (
                <div
                  key={t.event}
                  className="card-hover group flex items-start gap-5 rounded-lg border border-border bg-card p-6 transition-all duration-200 hover:border-brand-light/70 hover:shadow-md"
                >
                  <span className="shrink-0 grid h-11 w-11 place-items-center rounded-md bg-brand/5 text-accent-strong">
