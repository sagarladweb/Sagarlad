        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            >
              ...
              {hovered === "Blogs" && (
                <div className="absolute left-1/2 -translate-x-1/2 top-full pt-2 w-[440px] z-50">
                  <div className="rounded-2xl border border-border bg-background/98 backdrop-blur-xl shadow-2xl p-4">
                    {/* Blog / Videos / Quotes — direct links grid */}
                    ...
                    <div className="pt-3">
                        ...
                        {categories.length > 0 ? (
                          categories.slice(0, 6).map((c) => (
                            <Link
                              ...
                              href={`/content/${c.slug}`}
                              onClick={() => setHovered(null)}
                              className="flex items-center gap-2.5 px-3 py-2 rounded-xl hover:bg-muted/80 transition-colors text-sm font-medium text-foreground"
                            >
                          ...
                          <p className="px-3 py-2 text-sm text-muted-foreground col-span-2">
                            Topics coming soon.
                          </p>
                        )}
                      </div>
                      <Link
                        href="/content"
                        onClick={() => setHovered(null)}
                        className="mt-3 flex w-full items-center justify-center gap-1 rounded-xl bg-accent px-4 py-2.5 text-xs font-semibold text-accent-foreground transition-opacity hover:opacity-90 shadow-sm"
                      >
