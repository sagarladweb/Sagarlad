  ...
  return (
    <main className="relative flex min-h-[70vh] items-center justify-center overflow-hidden">
      ...
      <div className="relative mx-auto max-w-md px-4 py-24 text-center sm:px-6">
        ...
        <Link
          href="/"
          className="btn-premium mt-8 inline-flex items-center gap-2 rounded-full bg-accent px-7 py-3.5 text-sm font-semibold text-accent-foreground hover:opacity-90"
        >
